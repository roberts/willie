                            ...
                            <div class="lg:pl-20">
                                <ul role="list">
                                    ...
                                    <li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
                                        <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500" href="mailto:bobdao.sol@gmail.com">
                                            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-teal-500">
                                            ...
                                            <span class="ml-4">bobdao.sol@gmail.com</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
