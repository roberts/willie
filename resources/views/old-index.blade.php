            ...
            <div class="mx-auto w-full max-w-7xl lg:px-8">
                <div class="relative px-4 sm:px-8 lg:px-12">
                    <div class="mx-auto max-w-2xl lg:max-w-5xl">
                        <div class="max-w-2xl">
                            <h1 class="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">Willie Nelson Blockchain Fan Club</h1>
                            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400"></p>
                            <div class="mt-6 flex gap-6">
                                <a class="group -m-1 p-1" aria-label="Follow $BOB on X" href="https://x.com/BobdaoSol">
                                ...
                                <a class="group -m-1 p-1" aria-label="Follow $BOB on Telegram" href="https://t.me/WeAreAllBOB">
                                    <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                                ...
                                <a class="group -m-1 p-1" aria-label="$BOB on Gecko Terminal" href="https://www.geckoterminal.com/solana/pools/CjwQrhXiLV4VWTcLsauyKbHNWCgmh1y9FBLtQezqCvCu">
                                ...
                                <a class="group -m-1 p-1" aria-label="$BOB on Birdeye" href="https://birdeye.so/token/4rtdcn81czaDSGRdumyj76JFgeo55aZKXUURm2M2iVdN?chain=solana&tab=recentTrades">
                                ...
                                <a class="group -m-1 p-1" aria-label="$BOB on DexScreener" href="https://dexscreener.com/solana/cjwqrhxilv4vwtclsauykbhnwcgmh1y9fbltqezqcvcu">
                                ...
                                <a class="group -m-1 p-1" aria-label="$BOB on Jupiter" href="https://jup.ag/swap/SOL-BOB_4rtdcn81czaDSGRdumyj76JFgeo55aZKXUURm2M2iVdN">
